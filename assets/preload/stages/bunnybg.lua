...
function onCreate()
	...
	scaleObject('back', 0.33, 0.33);
	makeLuaSprite('floor', 'bg/floor', -600, -300);
	scaleObject('floor', 0.33, 0.33);
	makeLuaSprite('fg', 'bg/foreground', -600, -300);
	setScrollFactor('fg', 0.9, 0.9);
	scaleObject('fg', 0.33, 0.33);
	makeLuaSprite('spotlight', 'bg/spotlight', -600, -300);
	setBlendMode('spotlight', 'add');
	scaleObject('spotlight', 0.33, 0.33);
	
	makeAnimatedLuaSprite('dust','bg/dust', -10, 250);
	addAnimationByPrefix('dust','bop','dust', 24, false);
	scaleObject('dust', 0.8, 0.8);
	
	makeAnimatedLuaSprite('goober1','bg/minion', -800, 50);
    addAnimationByPrefix('goober1','appear','minion entrance', 24, false);
	addAnimationByPrefix('goober1','bop','minion0', 24, true);
	addAnimationByPrefix('goober1','death','minion death', 24, false);
	setProperty('goober1.flipX', true);
	
	makeAnimatedLuaSprite('goober2','bg/minion', 750, 50);
    addAnimationByPrefix('goober2','appear','minion entrance', 24, false);
	addAnimationByPrefix('goober2','bop','minion0', 24, true);
	addAnimationByPrefix('goober2','death','minion death', 24, false);
	
	makeAnimatedLuaSprite('smoke','bg/smoke', -500, 40);
	addAnimationByPrefix('smoke','bop','smoke idle', 24, true);
	addAnimationByPrefix('smoke','shootR','smoke shoot0', 24, false);
	addAnimationByPrefix('smoke','shootL','smoke shoot 2', 24, false);
	setProperty('smoke.alpha', 0);
	
	makeAnimatedLuaSprite('smokeappear','bg/smoke', -500, -60);
    addAnimationByPrefix('smokeappear','appear','smoke entrance', 24, false);
